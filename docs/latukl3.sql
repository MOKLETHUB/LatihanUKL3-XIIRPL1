...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2021 at 04:09 AM
...
('20211006030638-create-tb-member.js'),
('20211006030752-create-tb-outlet.js'),
('20211006030955-create-tb-paket.js'),
('20211006031254-create-tb-user.js'),
('20211006031416-create-tb-transaksi.js'),
('20211006032237-create-tb-detail-transaksi.js');
...
INSERT INTO `tb_outlet` (`id_outlet`, `nama`, `alamat`, `tlp`, `createdAt`, `updatedAt`) VALUES
(1, 'Gagas', 'Tulungagung', '085645784957', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO `tb_user` (`id_user`, `nama`, `username`, `password`, `id_outlet`, `role`, `createdAt`, `updatedAt`) VALUES
(1, 'Admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 'admin', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tb_transaksi`
  ADD CONSTRAINT `tb_transaksi_ibfk_1` FOREIGN KEY (`id_outlet`) REFERENCES `tb_outlet` (`id_outlet`),
